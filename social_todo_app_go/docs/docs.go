...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/social_todo_app_go_module_category_query.CategoryDTO"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/category/rpc/query-category-by-id": {
            "get": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/query.OrderDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/query.ProductDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/usecase.EmailPasswordLoginDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/usecase.SetSingleImageDTO"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/usecase.EmailPasswordRegistrationDTO"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "query.ProductDTO": {
            ...
            "properties": {
                "category": {
                    "$ref": "#/definitions/social_todo_app_go_module_product_query.CategoryDTO"
                },
                "category_id": {
                    "type": "string"
                },
        ...
        "social_todo_app_go_module_category_query.CategoryDTO": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "social_todo_app_go_module_product_query.CategoryDTO": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "usecase.EmailPasswordRegistrationDTO": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
